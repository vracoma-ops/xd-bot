...
# ---------------- CONFIG ----------------
GUILD_ID = 948971532431015976        # Your server ID
CONFIG_CHANNEL_ID = 1478282165618737266  # Channel to send vouch for approval
VOUCHES_CHANNEL_ID = 1478334777533927456  # Channel to post approved vouches
ADMIN_ID = 458624557763526666       # Admin Discord ID
...
async def on_raw_reaction_add(payload):
    ...
    if emoji == APPROVE_EMOJI:
        ...
        admin_user = guild.get_member(payload.user_id)
        if admin_user:
            approved_embed.set_footer(text=f"Approved by {admin_user.display_name}")
